...
class WeOfferSection extends StatelessWidget {
  ...
  Widget _desktop(context) => Container(
      ...
      color: AaxepTheme.lightWhite,
      padding: EdgeInsets.symmetric(vertical: Device.grid(context) * 0.5, horizontal: Device.grid(context) * 2),
      child: _view(context));

  Widget _mobile(context) =>
      Container(width: double.infinity, color: AaxepTheme.lightWhite, padding: EdgeInsets.all(Device.margin(context)), child: _view(context));
  ...
  Widget _weOfferContainer(context, {required String title, required String subTitle, required IconData icon}) => Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
        CircleAvatar(
            ...
            backgroundColor: AaxepTheme.primary.withOpacity(0.2),
        ...
        Padding(
            ...
            child: Text(title,
                style: Theme.of(context).textTheme.headline6!.copyWith(fontWeight: FontWeight.bold, color: Colors.black54),
